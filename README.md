...
* Cross-file search, so if you are working on multiple mods at a time you can search all of them easily. (And cross-file replace, so that you can easily refactor a function name.)
